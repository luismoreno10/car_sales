...
public class CarFeaturesTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public CarFeaturesTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Car_Features set %s = %s WHERE car_Feature_ID \'%s\'",
               colSQLName,
