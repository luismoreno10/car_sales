...
public class CarManufacturersTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public CarManufacturersTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Car_Manufacturers set %s = %s WHERE manufacturer_ShortName \'%s\'",
               colSQLName,
