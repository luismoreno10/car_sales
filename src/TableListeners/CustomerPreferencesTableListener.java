...
public class CustomerPreferencesTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public CustomerPreferencesTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Customer_Preferences set %s = %s WHERE customer_Preference_ID \'%s\'",
               colSQLName,
