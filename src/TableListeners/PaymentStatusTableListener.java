...
public class PaymentStatusTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public PaymentStatusTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Payment_Status set %s = %s WHERE payment_Status_Code \'%s\'",
               colSQLName,
