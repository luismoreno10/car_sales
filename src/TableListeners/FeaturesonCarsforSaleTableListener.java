...
public class FeaturesonCarsforSaleTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public FeaturesonCarsforSaleTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE features_on_Cars_for_Sale set %s = %s WHERE car_for_Sale_ID \'%s\'",
               colSQLName,
