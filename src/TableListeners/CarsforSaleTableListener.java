...
public class CarsforSaleTableListener implements TableModelListener{
    private final Base_Datos db;
    
    public CarsforSaleTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Cars_for_Sale set %s = %s WHERE car_for_Sale_ID \'%s\'",
               colSQLName,
