...
public class InsurancePoliciesTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public InsurancePoliciesTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Insurance_Policies set %s = %s WHERE policy_ID \'%s\'",
               colSQLName,
