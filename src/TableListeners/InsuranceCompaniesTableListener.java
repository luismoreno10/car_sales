...
public class InsuranceCompaniesTableListener implements TableModelListener{
    
    private final Base_Datos db;
    
    public InsuranceCompaniesTableListener(Base_Datos d){
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event){
        ...
        String sql = String.format(
               "UPDATE Insurance_Companies set %s = %s WHERE insurance_Company_ID \'%s\'",
               colSQLName,
